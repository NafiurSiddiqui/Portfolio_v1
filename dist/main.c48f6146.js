...
exports.checkProjectBodyActivation = checkProjectBodyActivation;
exports.transactionalActivatedDesktop = exports.promoActivatedDesktop = exports.projectWrapper = exports.newsletterActivatedDesktop = exports.landingPageActivatedDesktop = void 0;
...
exports.transactionalActivatedDesktop = transactionalActivatedDesktop;
var newsletterActivatedDesktop = null;
exports.newsletterActivatedDesktop = newsletterActivatedDesktop;
var landingPageActivatedDesktop = null;
exports.landingPageActivatedDesktop = landingPageActivatedDesktop;
...
},{"./projects":"src/js/projects.js","./tray":"src/js/tray.js","./nameCard":"src/js/nameCard.js"}],"src/sound/btns.mp3":[function(require,module,exports) {
module.exports = "/btns.e3b91b9c.mp3";
},{}],"src/sound/reset.mp3":[function(require,module,exports) {
module.exports = "/reset.ba1b3a26.mp3";
},{}],"src/sound/cardOn_A.mp3":[function(require,module,exports) {
module.exports = "/cardOn_A.6c6ebd04.mp3";
},{}],"src/sound/cardOn_B.mp3":[function(require,module,exports) {
module.exports = "/cardOn_B.7061c2d4.mp3";
},{}],"src/sound/social.mp3":[function(require,module,exports) {
module.exports = "/social.3771f9f9.mp3";
},{}],"src/sound/contact.mp3":[function(require,module,exports) {
module.exports = "/contact.cef3ed37.mp3";
},{}],"src/sound/trayUp.mp3":[function(require,module,exports) {
module.exports = "/trayUp.d3dcc611.mp3";
},{}],"src/sound/mail.mp3":[function(require,module,exports) {
module.exports = "/mail.54b48911.mp3";
},{}],"src/js/sound.js":[function(require,module,exports) {
"use strict";

var _btns = _interopRequireDefault(require("../sound/btns.mp3"));

var _reset = _interopRequireDefault(require("../sound/reset.mp3"));

var _cardOn_A = _interopRequireDefault(require("../sound/cardOn_A.mp3"));

var _cardOn_B = _interopRequireDefault(require("../sound/cardOn_B.mp3"));

var _social = _interopRequireDefault(require("../sound/social.mp3"));

var _contact = _interopRequireDefault(require("../sound/contact.mp3"));

var _trayUp = _interopRequireDefault(require("../sound/trayUp.mp3"));

var _mail = _interopRequireDefault(require("../sound/mail.mp3"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var sideA = document.querySelector('.main-content__card-sideA');
var sideB = document.querySelector('.main-content__card-sideB');
var projectBtnDesk = document.querySelectorAll('.project-btn');
var projectBtnTray = document.querySelectorAll('.project-btn__tray');
var logoBtn = document.querySelector('.header__logo-container');
var contactBtn = document.querySelector('.header__contact');
var socialMediaBtn = document.querySelectorAll('.social-media_link');
console.log(socialMediaBtn);
var mailBtn = document.querySelector('.contact-screen__mail-btn'); //sounds

var socialSound = new Audio(_social.default);
socialSound.volume = 0.30;
var namecardOn_A = new Audio(_cardOn_A.default);
namecardOn_A.volume = 0.30;
var namecardOn_B = new Audio(_cardOn_B.default);
namecardOn_B.volume = 0.30;
var btnProject = new Audio(_btns.default);
btnProject.volume = 0.20;
var contactSoundOn = new Audio(_contact.default);
contactSoundOn.volume = 0.20;
var resetSound = new Audio(_reset.default);
resetSound.volume = 0.20;
var traySound = new Audio(_trayUp.default);
traySound.volume = 0.20;
var mailSound = new Audio(_mail.default);
...
projectBtnDesk.forEach(function (btn) {
...
projectBtnTray.forEach(function (btn) {
  btn.addEventListener('click', function () {
    btnProject.play();
  });
});
socialMediaBtn.forEach(function (btn) {
  btn.addEventListener('click', function () {
    socialSound.play();
  });
});
...
},{"../sound/btns.mp3":"src/sound/btns.mp3","../sound/reset.mp3":"src/sound/reset.mp3","../sound/cardOn_A.mp3":"src/sound/cardOn_A.mp3","../sound/cardOn_B.mp3":"src/sound/cardOn_B.mp3","../sound/social.mp3":"src/sound/social.mp3","../sound/contact.mp3":"src/sound/contact.mp3","../sound/trayUp.mp3":"src/sound/trayUp.mp3","../sound/mail.mp3":"src/sound/mail.mp3"}],"src/js/main.js":[function(require,module,exports) {
"use strict";
...
require("./sound");
},{"./tray":"src/js/tray.js","./nameCard":"src/js/nameCard.js","./projects":"src/js/projects.js","./slider":"src/js/slider.js","./logoReset":"src/js/logoReset.js","./contactBtn":"src/js/contactBtn.js","./sound":"src/js/sound.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
